...
class YahooSpider(CrawlSpider):
    ...
    #https://news.yahoo.com/prageru-oklahoma-schools-ryan-walters-florida-propaganda-texas-173136729.html
    ...
    def parse_item(self, response):
        ...
        jsonData = json.loads(
            response.xpath('//article[@role="article"]/script[@type="application/ld+json"]/text()').get())
